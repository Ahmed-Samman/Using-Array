...
void CopyOddNumbers(int Array[100], int CopyArray[100], int ArrLength, int& CopyLength)
{
...
int main()
{
	...
	CopyOddNumbers(Array, CopyArray, ArrLength, CopyLength);
